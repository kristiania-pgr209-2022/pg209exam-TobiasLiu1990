INSERT INTO users (full_name, email_address, favorite_color)
VALUES ('Ola Nordman', 'olno@gmail.com', 'red'),
       ('Snorre Snorreson', 'snorre@gmail.com', 'black'),
       ('Tobias Tobiasson', 'tobe@gmail.com', 'green'),
       ('Elon Musk', 'musken@tesla.ru', 'blue'),
       ('Mahamta Ghandi', 'peace@nowar.in', 'brown');
